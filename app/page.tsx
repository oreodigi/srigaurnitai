...
export default async function HomePage(){
 const [{data:contests},{data:businesses},{data:videos}]=await Promise.all([
  supabase.from("contests").select("id,title,slug,description,contest_categories(name)").eq("is_active",true).order("is_featured",{ascending:false}).limit(5),
