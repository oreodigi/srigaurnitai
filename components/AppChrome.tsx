...
import { Bell, BookOpen, BriefcaseBusiness, CalendarHeart, CircleHelp, CircleUserRound, Home, PlayCircle, Trophy } from "lucide-react";
import { usePathname } from "next/navigation";
import { BrandLogo } from "@/components/BrandLogo";
import { SiteFooter } from "@/components/SiteFooter";
import {useSiteUI} from "@/components/SiteUI";
const iconFor=(href:string)=>href==="/contests"?Trophy:href==="/events"?CalendarHeart:href==="/businesses"?BriefcaseBusiness:href==="/blog"?BookOpen:href==="/account"?CircleUserRound:Home;
const fallback=[{href:"/",label:"Home"},{href:"/contests",label:"Contests"},{href:"/events",label:"Events"},{href:"/businesses",label:"Businesses"},{href:"/blog",label:"Journal"}];
...
export function AppChrome({children}:{children:React.ReactNode}){
 ...
 const configured=Array.isArray(s.desktop_nav_items)&&s.desktop_nav_items.length?s.desktop_nav_items:fallback;
 const desktop=configured.some((x:any)=>x.href==="/blog")?configured:[...configured,{href:"/blog",label:"Journal"}];
